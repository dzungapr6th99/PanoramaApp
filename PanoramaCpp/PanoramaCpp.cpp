...
namespace PanoramaCpp
{
	...
	int MergeImage()
	{
		...
		Images.push_back(cv::imread("C:\\Users\\admin\\source\\repos\\PanoramaApp\\PanoramaApp\\Hill1.JPG"));
		Images.push_back(cv::imread("C:\\Users\\admin\\source\\repos\\PanoramaApp\\PanoramaApp\\Hill2.JPG"));
